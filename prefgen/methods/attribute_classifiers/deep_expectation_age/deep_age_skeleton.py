...
from prefgen.methods.attribute_classifiers.deep_expectation_age.deep_age_model import VGG
from prefgen.methods.attribute_classifiers.utils.tensor_transforms import center_crop_tensor
