...
def evaluate_mcmv_performance(
    ...
    num_attributes=2,
    num_queries=30,
    num_query_samples=[16, 32, 64]
):
    save_data = {}
    # For each number of query intervals
    for num_samples in num_query_samples:
        print(f"Evaluating num samples {num_samples}...")
        final_errors = []
        ...
        save_data[num_samples] = final_errors
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mcmv_data_path", 
        type=str, 
        default="data/mcmv_different_num_samples.pkl"
    )
    parser.add_argument(
        "--num_examples",
        default=50
