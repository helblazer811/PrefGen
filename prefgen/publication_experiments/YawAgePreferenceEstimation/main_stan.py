...
if __name__ == "__main__":
    ...
    parser.add_argument("--attribute_names", type=list, default=["yaw", "age"]) #"pitch", "light0", "light3", "age"])
    parser.add_argument("--target_attributes", default=torch.Tensor([0.1, 0.85]).cuda())
